...
function package:registerCommands ()
   self.commands:register("font:clear-fallbacks", function ()
   ...
   self.commands:register("font:add-fallback", function (options, _)
   ...
   self.commands:register("font:remove-fallback", function ()
