...
local bibtexparser = epnf.define(function(_ENV)
   ...
   local myTag = C(identifier + lpeg.P(1)) / function(t)
      return t:lower()
   end
   local value = balanced + doubleq + myID
   local pair = lpeg.Cg(myTag * _ * "=" * _ * C(value))
      * _
      * sep ^ -1
      / function(...)
         local t = { ... }
   ...
   comment = WS
      ...
      ) -- Don't bother telling me about comments
   blockcomment = (P("@") * commentKey) + balanced / function()
      return ""
