...
local _key = function(options,text)
  return table.concat({text,options.font;options.language;options.script;options.size;("%d"):format(options.weight);options.width;options.style;options.variant;options.features;options.direction;options.filename},";")
end
