...
// These env vars are generated by autoconf *at compile time* in order to emulate the system
// default Lua interpreter. If they exist we use them, else keep it to ourselves.
lazy_static! {
    #[derive(Debug)]
    pub static ref LUA_PATH: &'static str = option_env!["LUA_PATH"].unwrap_or_else(|| "./?.lua");
    #[derive(Debug)]
