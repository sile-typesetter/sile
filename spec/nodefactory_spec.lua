...
describe("The node factory", function()
  ...
  describe("hboxes", function()
    ...
    it("should be a box (not glue)", assert.is.truthy(hbox:isBox()) and assert.falsy(hbox:isGlue()))
  ...
  describe("vboxes", function()
    ...
    it("should be a box (not glue)", assert.is.truthy(vbox:isBox()) and assert.falsy(vbox:isGlue()))
