...
describe("The node factory", function()
  it("should exist", function() assert.is.truthy(SILE.types.node) end)
  ...
  describe("discs", function ()
    ...
    local discretionary = SILE.types.node.discretionary({ prebreak = { nnode1, nnode2 }, postbreak = { nnode3, nnode2  } })
